    ...
    <TeamAccountWorkspaceContextProvider value={data}>
      <SidebarProvider defaultOpen={state.open}>
        <Page style={'sidebar'}>
          ...
          <RemainingTicketsForAccount accountId={data.account.id} />
...
function RemainingTicketsForAccount(props: { accountId: string }) {
  const remainingTickets = use(getRemainingTicketsForAccount(props.accountId));
  ...
  return (
      <div
          className={'bg-red-500 py-1 text-center text-xs font-medium text-white'}
      >
