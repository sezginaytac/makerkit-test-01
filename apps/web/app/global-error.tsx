...
// Wrapper component that safely handles user data
function GlobalErrorContent({
  ...
  // Don't use useUser() here to avoid React Query context issues
  const user = null; // We'll handle this without user data for now
